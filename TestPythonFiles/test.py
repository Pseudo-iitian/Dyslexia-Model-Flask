...
feature_array = get_feature_array("/home/abhishek/Documents/TryingModel_Dyslexia/data/dyslexic/1.jpg")
result = score(feature_array)
if result[0] == 1:
  print("From the tests on this handwriting sample there is very slim chance that this person is sufferning from dyslexia or dysgraphia")
else:
  print("From the tests on this handwriting sample there is very high chance that this person is sufferning from dyslexia or dysgraphia")